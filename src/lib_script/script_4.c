...
static Position init_pos_blue = {2.55f, 1.9f, -1.57f}; 
static Position init_pos_yellow = {0.55f, 1.9f, -1.57f};
...
void script_match_4_loop(void){
    ...
    switch (match_state) {
        ...
        case 2:
            ...
            avoidance_en = 0; // On sécurise le repli avec l'esquive
        ...
        case 7:
            ...
            if (IHM.team_state == JAUNE) {
                Goal_Pos.x = 1.25f; Goal_Pos.y = 1.55f; Goal_Pos.t = init_pos.t;
            } else {
                Goal_Pos.x = 1.75f; Goal_Pos.y = 1.55f; Goal_Pos.t = init_pos.t;
            }  
            avoidance_en = 1;  
            motion_pos(Goal_Pos); //[cite: 5]
            match_state++; 
