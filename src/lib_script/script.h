...
#define START_MATCH_DELAY 10000//85000
#define ENDGAME_TIME 25000 //100000
#define SERVO_ACTIVATION_TIME (ENDGAME_TIME - 10000) // 90 secondes en ms (soit 10s avant la fin de 100s)
#define START_PLACEMENT_TIME 5000 //15000 // 15 secondes pour le placement initial avant de commencer les mouvements
